...
public class RemindV3 implements CommandV3 {
    ...
    public List<AiTemplate> aiTemplate() {
        ...
        voList.add(new AiTemplate("system", "请将给出的内容归纳为以下格式: yyyy-MM-dd/HH:mm:ss 内容"));
        voList.add(new AiTemplate("user", "当前时间为2023年04月13日11:26:02;3天后早上8点提醒我去机场接我的朋友ammy"));
        voList.add(new AiTemplate("assistant", "2023-04-16/08:00:00 记得去机场接你的朋友ammy"));
        voList.add(new AiTemplate("user", "当前时间为2023年04月13日11:26:02;2023年05月10日是peter的生日，记得提前提醒我为他准备生日礼物"));
        voList.add(new AiTemplate("assistant", "2023-05-07/00:00:00 距离peter的生日只剩下3天了，记得准备好生日礼物。"));
